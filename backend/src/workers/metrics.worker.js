...
const collectMetrics = async () => {
    try {
        ...
        //debug
        //console.log(`[${new Date().toLocaleTimeString()}] ANTES DE DB CPU ${cpuUso}% ${cpuTemp}º | GPU ${gpuUso}% ${gpuMemUso}% ${gpuTemp}% | RAM ${ramUso}% | Disco ${discoUso}% | Net In ${netIn} MB | Net Out ${netOut} MB`);
        ...
        //debug
        console.log(`[${new Date().toLocaleTimeString()}] CPU Use ${cpuUso}% Temp ${cpuTemp}º | GPU Use ${gpuUso}% ${gpuMemUso}%  Temp ${gpuTemp}% | RAM ${ramUso}% | Disco ${discoUso}% | Net In ${netIn} MB | Net Out ${netOut} MB`);
